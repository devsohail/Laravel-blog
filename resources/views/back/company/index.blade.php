        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('admin/companies/create') }}" class="btn btn-success btn-sm"
                                ...
                                <tbody>
                                    @foreach ($company as $item)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('images/company/' . $item->company_logo) }}" alt="Company Logo" style="width: 100px; height: auto;"></td>
                                            <td>{{ $item->monthly_rate }}</td>
                                            <td>
                                                {{-- <a href="{{ url('/admin/companies/' . $item->id) }}"
                                                    title="View Company"><button class="btn btn-info btn-sm"><i
